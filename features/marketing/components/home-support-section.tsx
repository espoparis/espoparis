  ...
  return (
    <section className="full-bleed bg-[#0b3329] text-white">
      <div className="page-shell py-14 sm:py-16 lg:py-20">
        <div className="border-t border-white/20 py-8 lg:flex lg:items-center lg:justify-between lg:gap-12">
          ...
          <Link href={"/support"} locale={locale} className="mt-7 inline-flex shrink-0 items-center border-b border-[#e0c27a] px-1 py-3 text-sm font-semibold text-[#e0c27a] transition hover:text-white lg:mt-0">
